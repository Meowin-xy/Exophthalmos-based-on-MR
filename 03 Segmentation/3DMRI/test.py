...
def save_nii(id, data, label, output, save_path):
    ...
    data_path = os.path.join('E:/data/all/', id+'.nii.gz')
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_path", type=str, default='E:/gxy2025/tao-cal/Output/Unet/Unet_Mar18-13-51/save_models/model_epoch_best.pth', help="path to the config file")  # 添加参数
    parser.add_argument("--testFolder", type=str, default='E:/data/all/validation', help="path to the config file")  # 添加参数
    parser.add_argument("--model", type=str, default='Unet', help="Unet | SEnet")
