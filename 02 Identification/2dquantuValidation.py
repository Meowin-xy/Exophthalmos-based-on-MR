...
if __name__ == "__main__":
    # Define directories
    quantu_slice_directory = r"C:\Users\xrVis001\Desktop\EyeData\Eyeball0714\Eyeball0714\Validation\2D\quantuSlice"
    quantu_mask_directory = r"C:\Users\xrVis001\Desktop\EyeData\Eyeball0714\Eyeball0714\Validation\2D\quantuMask"
    output_directory = r"C:\Users\xrVis001\Desktop\EyeData\Eyeball0714\Eyeball0714\Validation\2D"
    
    # Load the zygomatic detection model
    base_dir = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
    model_path = os.path.join(base_dir, "finalnewdata", "saved_models", "zygomatic_model_20250625_151231.pth")
